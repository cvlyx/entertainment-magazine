      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-lg font-medium text-gray-900">Welcome, {session?.user?.name || 'User'}!</h2>
            <p className="mt-1 text-sm text-gray-600">
              You're now logged in to your dashboard. This is where you can manage your account and access exclusive content.
            </p>
                  ...
                  <li>
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-medium text-indigo-600 truncate">Account Created</p>
                      ...
                      <div className="mt-2 sm:flex sm:justify-between">
                        <div className="sm:flex">
                          <p className="flex items-center text-sm text-gray-500">
                            Welcome to your new account! Start exploring the dashboard.
                          </p>
                        </div>
                        <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                          ...
                          <p>
                            <time dateTime="2023-04-01">{new Date().toLocaleDateString()}</time>
                          </p>
                        </div>
                      </div>
                    </div>
